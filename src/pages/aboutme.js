    ...
    <Layout leftHiddenMobile>
      ...
      <Section bgGrey id="aboutme">
        ...
        <p>In het dagelijkse leven werk ik sinds maart 2021 rond welzijn op het werk als veiligheidsconsultant, ook wel gekend als preventieadviseur. 
          Hiernaast kan je mij vinden als (hoofd)animator op voornamelijk buitenlandse jeugdkampen. En naast dit alles, kan ik ook jouw persoonlijke gezondheidscoach en bodyworker zijn. Als gezondheidscoach ben ik erkent bij de Vlaamse Vereniging GezondheidsCoaches (VVGC) onder het erkenningsnummer 19-01-02-004.</p>
